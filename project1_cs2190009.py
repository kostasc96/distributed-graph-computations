...
vertices = spark.read.format("csv").option("header","true").load('files/nodes.csv')
edges = spark.read.format("csv").option("header","true").load('files/edges.csv')
...
# ### Create graph
g = GraphFrame(cached_vertices, g.edges)
#g.vertices.show()
#g.edges.show()
#g.degrees.show()
